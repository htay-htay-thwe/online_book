                ...
                <form method="post" action="{{ route('post#update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <img name="bookImage" src="{{ asset('books/' . $data->bookImage) }}" class="card-img-top w-100"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="au-input au-input--full @error('bookName') is-invalid @enderror"
                                    ...
                                    value="{{ old('username', $data->bookName) }}">
                                @error('bookName')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="au-input au-input--full @error('writerName') is-invalid @enderror"
                                    ...
                                    value="{{ old('username', $data->writerName) }}">
                                @error('writerName')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input value="{{ old('price', $data->price) }}"
                                    class="au-input au-input--full @error('price') is-invalid @enderror" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="au-input au-input--full @error('description') is-invalid @enderror" cols="30" row="10"
                                    type="text" name="description" placeholder="Description">{{ $data->description }}</textarea>
                                @error('description')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
